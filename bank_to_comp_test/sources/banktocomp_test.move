...
module bank_to_comp::messenger_test {
    ...
    fun test_create() {
        ...
        {
            // Initialize the banktocomp module for testing purposes.
            // This might set up necessary state, defaults, or mock data.
            banktocomp::init_for_testing(test_scenario::ctx(scenario));
        };
        ...
        test_scenario::next_tx(scenario, owner);
        {
            ...
            let admin = test_scenario::take_from_sender<BankIdentity>(scenario);
            ...
            // Return the `BankIdentity` resource back to the sender's account after the operation.
